...
//  glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
  ...
  // Draw the particles
  glPointSize(1.0f);
  renderParticlesProg->set_uniform_vec4("Color", glm::vec4(0.8f,0.1f,0.1f,0.2f));
  glBindVertexArray(particlesVao);
  ...
  // renderParticlesProg.setUniform("Color", glm::vec4(1,1,0,1.0f));
  ...
  // render3DProg.setUniform("ModelViewMatrix", mv);
  // render3DProg.setUniform("NormalMatrix", norm);
  // render3DProg.setUniform("MVP", proj * mv);
