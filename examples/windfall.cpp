...
void display(GLFWwindow *window) {
  ...
  std::cout << "Texture max size : " << texture_size << std::endl;
...
//--------------------------Skybox rendering---------------------------
    ...
    if (offset_water > 1.0)
      offset_water = -1.0;
    program_shore->set_uniform_float("offset", offset_water);
...
//    view = glm::translate(view, glm::vec3(-offset * 10));
    ...
    program_shore->set_uniform_float("alpha_clip", alpha_clip);
